...
path/to/vcftools --vcf granulifera_GATK_variants.filtered.SNPS.biallelic.vcf --minDP 3 --maf 0.05 --max-missing 0.75 \
...
path/to/plink2 --vcf granulifera_GATK_variants.filtered.biallelic.SNPs.minDP3mac3maxmissing8.recode.vcf \
...
path/to/plink --bfile granulifera_GATK_variants.filtered.biallelic.SNPs.minDP3mac3maxmissing8.LDpruned.PLINK \
--allow-extra-chr --recode A --out granulifera_GATK_variants.filtered.biallelic.SNPs.minDP3mac3maxmissing8.LDpruned.PLINK

path/to/plink --bfile granulifera_GATK_variants.filtered.biallelic.SNPs.minDP3mac3maxmissing8_noCDS.LDpruned.PLINK \
--allow-extra-chr --recode --tab --out granulifera_GATK_variants.filtered.biallelic.SNPs.minDP3mac3maxmissing8.LDpruned.PLINK

path/to/plink2 --bfile granulifera_GATK_variants.filtered.biallelic.SNPs.minDP3mac3maxmissing8.LDpruned.PLINK --allow-extra-chr --freq
...
path/to/plink2 --bfile granulifera_GATK_variants.filtered.biallelic.SNPs.minDP3mac3maxmissing8.LDpruned.PLINK \
